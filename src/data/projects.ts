...
export const PROJECTS: Project[] = [
  {
    ...
    sectionId: 'room',
    status: 'active',
    tagline: 'An autonomous team running the isark artist project.',
    ...
    lastMove: 'Hemera drafted the Q3 release calendar and handed promo tasks to Nyx.',
    nextMove: 'Wire the team into the real Discord + SoundCloud APIs.',
    progress: 62,
  ...
  },
  {
    ...
    links: [{ label: '@isark', href: 'https://soundcloud.com/itsisark' }],
    timeline: [
