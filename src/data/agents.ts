...
export const AGENTS: Agent[] = [
  ...
  },
  {
    ...
    color: '#e3d24b',
    status: 'idle',
    task: 'Scanning the scene for the weekly read',
    stats: { tasksDone: 0, tokens: '0', uptime: '—', load: 0.05 },
    chatter: [
      'Short-form vertical clips are still the cheapest reach — flagging it.',
      'Three comparable artists leaning into the same tempo lane.',
      'Drafted the market pulse; handed two opportunities to Hemera.',
      "Careful — that trend's a guess until we verify it.",
    ],
  },
  {
    id: 'argus',
    ...
    color: '#ff6b6b',
    status: 'idle',
    task: 'Auditing the last run',
    stats: { tasksDone: 0, tokens: '0', uptime: '—', load: 0.05 },
    chatter: [
      'Two handoffs from yesterday never got picked up — chasing them.',
      'Brief was vague on the ask. Sent it back for a sharper version.',
      'Pipeline health: green, but intake is the bottleneck.',
      'This analysis overstates its confidence. Fix before it ships.',
    ],
  },
  {
    id: 'nyx-w1',
